...
let roundedAverage = Math.ceil(scoresAverage(movies) * 100) / 100;

console.log('scoresAverage', roundedAverage);
...
let roundedAverageDrama = Math.ceil(dramaMoviesScore(movies) * 100) / 100;

console.log('dramaMoviesScore', roundedAverageDrama);
...
function orderAlphabetically(moviesArray) {
    ...
    const frist20Titles = movies.slice(0, 20).map(movie => movie.title);
    return frist20Titles;
 }

 const first20Titles = orderAlphabetically(movies);
console.log('First 20 titles alphabetically ordered:', first20Titles)
